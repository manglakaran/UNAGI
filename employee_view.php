...
<html>
  <head>
    ...
    tableIndexes = ["employee_id_prev", "f_name", "l_name", "address", "phone_no", "email_id", "employee_id", "designation", "salary"];
    function deleteEmployee () {
        var parent = $(this).parent();
        $.ajax({
          url:'./employee_delete.php',
          type:"POST",
          data: {"employee_id" : parent.attr('id')},
      ...
      <tbody>
          <?php
            ...
            while($row = mysql_fetch_assoc($result)) {
              echo "<tr clas='row' id= '" . $row["employee_id"] . "'>";
              ...
              echo "<td class='field'>". $row["email_id"] ."</td>";
              echo "<td class='field'>". $row["employee_id"] ."</td>";
              echo "<td class='field'>". $row["designation"] ."</td>";
              echo "<td class='field'>". $row["salary"] ."</td>";
